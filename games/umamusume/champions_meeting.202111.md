...
v0.2、条件公開後の育成・試走結果まで更新。
v0.2.1、本戦前にライブラ杯以降リリースされたウマ娘のスコーピオ杯適正を更新。

<https://twitter.com/uma_musu/status/1461530938085867521?s=20>
...
整理すると、最終コーナー速度スキルは固有スキルの本人/継承を問わず有効で「終盤」前の位置上げに使える。より高い速度からスパートを切れるため疑似的に終盤加速スキルを発動したような作用もある。最終コーナー加速スキルは固有スキルの本人だけが有効でスパート時最速で効果を発揮する加速スキルに数えられる。
...
「八方睨み」を習得可能なのが [ポインセチア・リボン] ナイスネイチャのみで、範囲指定が前方で逃げウマ娘にも当たる「魅惑のささやき」の枠を実質的に兼ねるのも意味がある。1発ではやや役者不足だが、逃げ牽制/焦りを重ねればスパート速度を落とせる可能性は十分ある。
...
## エースのスタミナ不安もグレードリーグAグループ決勝は目指せるか

中距離適正Sをつけた逃げ/先行のエースクラスを多数育成できていること、それをサポートできるデバフ枠を「独占力」「八方睨み」双方の枠で用意できている事は及第点だが、グレードリーグAグループ決勝を征することができるかというと多少の不安要素が残っている。

自分のCMTGs向けの育成の常ではあるのだけれど、スタミナ不安が拭えない。現時点で育成できているエース格はそれぞれデバフを考慮の外に置けば最速スパートで終盤を駆け抜けられるものの、「魅惑のささやき」1発分が許容ギリギリの様子で立ち上がってしまうシーンが多々見受けられる。とくに叩き台込みでの育成だった初期メンバーにその傾向があり、「円弧のマエストロ」を取得できる場面で中盤スキルを優先した事もあるのでやや悔いが残る。緑スキルによるスピード強化という分かりやすい強化点も残っているので、予選の状況を見て意欲次第で一回り上の育成に臨むかもしれない。

デバフは因子をあまり厳選してこなかったのでさらに強力な育成を狙ってするのが難しいところだ。できれば「独占力」枠で逃げ/先行/差しにきちんと当たっていけるウマ娘を育成したいが、その因子作りがシンボリルドルフで止まっていてアグネスタキオン/グラスワンダーに持っていける状況にない。

まだスコーピオ杯本戦の実施スケジュールが出ていないが、残り日数はそうないはず。恐らくはエースかデバフ枠の強化かどちらかに余力を振り分けていく形になるだろう。
