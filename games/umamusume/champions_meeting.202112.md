...
v0.2、参加リーグ選択期間中。エキシビションを回してのメタゲーム予想など。
...
### 先行エースの逃げポジションガチャが最大の焦点になるメタゲーム

エキシビションを回したところ、10月ライブラ杯に比べメタゲームは基本形を変えずにさらに先行優位に傾いた印象だ。

逃げエースは自分が主戦場にしている評価値14500~15999帯では先行から逃げ切れるレベルをお見かけしていないので割愛する。
...
先行/追込に二極化したメタゲームでどうやって確率ガチャを掴み取るか、ユーザーが介入する方法はあまり見当たらない。

先行の逃げポジションガチャに賭けるなら賭けるで何か勝率を上げる方法を考えたいが、今のところコンセントレーションを積む以外の方法に心当たりがない。（効果があるか要検証。）
...
次にメタゲームに干渉する手段としてデバフを撃ち合うのか、デバフから身を護るのか、隙間を縫えるよう脚質を選択するのか、三択くらいの選択肢がなくては繰り返しの育成以上の要素の不足が否めない。対の択としていくらか成立するような調整が必要に思える。

## 未だ本戦出走メンバーが未完成

<https://twitter.com/645reform/status/1472487088339943428>

先週の中ごろからようやく本戦向けの育成を始めたものの仕上がりが今ひとつ。どうにかライブラ杯の転用より良さそうなのがメジロマックイーンの2枚のみ。

他、育成予定だったナリタタイシンは長距離Sの仕上げが上手くいっておらず、直線一気ゴールドシップは未着手という有様。エキシビションを回した感じ、逃げ不在時の逃げポジガチャの確率を高めるために先行2枚の選出はそこそこ有用そうなのでもう1枚、先行枠で [ノエルルージュ・キャロル] ビワハヤヒデあたりを用意したいという欲望が出てきたので決勝ラウンドまでのTODOはまだまだ未消化である。

<https://twitter.com/645reform/status/1471960883668844548>

参考程度にサブアカウントの編成を紹介しておくと、こちらはそもそもの手札が少ないこともあり、ほぼほぼ完成と見れるエース3枚の育成が完了済み。因子周回に移っている。

<!-- 締め -->

オープンリーグ上位に挑むわけでもなく、あわよくばグレードリーグB決勝1着といったサブアカウントはともかく、グレードリーグA決勝1着を目指すメインアカウントはまだまだこれから。予選ラウンドでも使用感を確かめつつ、できる範囲で勝率を高めるチーム編成を試したいところだ。

それではみなさん、サジタリウス杯本戦でもよきウマ娘ライフを。
