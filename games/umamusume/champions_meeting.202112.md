...
「リードキープ」目的で [明日は全国的に赤でしょう] セイウンスカイ、「真っ向勝負」目的で [フォーメーション:PARTY] マヤノトップガンを採用する。

「リードキープ」は逃げが出ていない時の先行策が逃げポジションを奪った時に仕事をする。追込との差を「終盤」前に取り返しがつかないものにして逃げ切るために仕込みたい。

「真っ向勝負」は'21クリスマスイベントのリリースで追加された先行向けの「終盤」加速スキル。「終盤」最速なら先行向けの「直線一気」、ランダムなら「乗り換え上手」相当で、いづれにせよ先行策としては待望の「終盤」指定の加速スキルという事になる。10月ライブラ杯ではハナを取っての継承「アングリング×スキーミング」しか有効な終盤加速を持たなかったメタゲームに強い影響を与えそうだ。
